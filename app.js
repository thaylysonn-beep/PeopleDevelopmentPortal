    ...
    <div class="acoes">
                    ...
                    <div class="aviso-matriz">
                        ...
                        <div>
                            ...
                            <p>
                                As competências são cadastradas
                                pelo Gestor e podem ser reutilizadas
                                em outros cargos.
                            </p>
        ...
        botao => {
            ...
            botao.onclick =
                async () => {
                    ...
                    const confirmar =
                        confirm(
                            `Deseja excluir a competência "${habilidade}" desta área?`
                        );
                    ...
                    // =====================================
                    // REMOVE A COMPETÊNCIA SOMENTE DA ÁREA
                    // =====================================
                    ...
                    // =====================================
                    // REMOVE O NÍVEL ESPERADO DA COMPETÊNCIA
                    // EM TODOS OS CARGOS DA ÁREA
                    // =====================================
...
// =====================================
// CORREÇÕES VISUAIS - TEMA CLARO
// SOMENTE APARÊNCIA
// NÃO ALTERA DADOS OU FUNCIONALIDADES
// =====================================

(function aplicarTemaClaroApp(){

    if(document.getElementById("temaClaroAppJS")){
        return;
    }

    const style = document.createElement("style");
    style.id = "temaClaroAppJS";

    style.textContent = `

        /* =====================================================
           SELETOR DE NÍVEL DA MATRIZ
           ===================================================== */

       .sistema-layout .tabela-container select.nivel{
    ...
    display:block !important;
        ...
        .sistema-layout .tabela-container select.nivel option{
            background:#ffffff !important;
            color:#263238 !important;
        }
        ...
        /* =====================================================
           LIXEIRA - EXCLUIR COMPETÊNCIA
           ===================================================== */

        .sistema-layout .btnExcluirHabilidade{
            background:#ffffff !important;
            background-color:#ffffff !important;
        ...
        #modalCompetencia > div{
            background:rgba(31,41,51,.45) !important;
        }

        #modalCompetencia > div > div{
            background:#ffffff !important;
            background-color:#ffffff !important;
            color:#263238 !important;
        ...
        #modalCompetencia label{
            color:#263238 !important;
        }

        #modalCompetencia input,
        #modalCompetencia select,
        #modalCompetencia textarea{
            background:#ffffff !important;
            background-color:#ffffff !important;
            color:#263238 !important;
            border:1px solid #cbd5df !important;
        ...
        #modalCompetencia input::placeholder,
        #modalCompetencia textarea::placeholder{
            color:#8a96a0 !important;
        }

        #modalCompetencia option{
            background:#ffffff !important;
            color:#263238 !important;
        }

        #modalCompetencia input:focus,
        #modalCompetencia select:focus,
        #modalCompetencia textarea:focus{
            outline:none !important;
            border-color:#0b8bd3 !important;
            box-shadow:0 0 0 2px rgba(11,139,211,.12) !important;
        }

        #modalCompetencia [style*="#aeb7bf"]{
            color:#68757f !important;
        }

        #modalCompetencia [style*="#303840"]{
            border-color:#e3e8ec !important;
        }

        #modalCompetencia button[id="btnFecharFormularioCompetencia"]{
            background:#ffffff !important;
        ...
        /* =====================================================
           MODAL PESQUISAR COMPETÊNCIA
           ===================================================== */

        #modalPesquisaCompetencias > div{
            background:rgba(31,41,51,.45) !important;
        }

        #modalPesquisaCompetencias > div > div{
            background:#ffffff !important;
            background-color:#ffffff !important;
            color:#263238 !important;
            border-color:#dfe4e8 !important;
        ...
        #modalPesquisaCompetencias h2{
            color:#0b6fa8 !important;
        }

        #modalPesquisaCompetencias input{
            background:#ffffff !important;
            background-color:#ffffff !important;
            color:#263238 !important;
            border:1px solid #cbd5df !important;
        ...
        #modalPesquisaCompetencias input::placeholder{
            color:#8a96a0 !important;
        }

        #modalPesquisaCompetencias input:focus{
            outline:none !important;
            border-color:#0b8bd3 !important;
            box-shadow:0 0 0 2px rgba(11,139,211,.12) !important;
        }

        #modalPesquisaCompetencias [style*="#1b2026"]{
            background:#ffffff !important;
            background-color:#ffffff !important;
            color:#263238 !important;
            border-color:#dfe4e8 !important;
        ...
        #modalPesquisaCompetencias [style*="#38434e"]{
            border-color:#dfe4e8 !important;
        }

        #modalPesquisaCompetencias [style*="#20262d"],
        #modalPesquisaCompetencias [style*="#252b32"],
        #modalPesquisaCompetencias [style*="#1e252c"]{
            background:#ffffff !important;
            background-color:#ffffff !important;
            color:#263238 !important;
            border-color:#cbd5df !important;
        ...
        #modalPesquisaCompetencias [style*="#303840"]{
            border-color:#e3e8ec !important;
        }

        #modalPesquisaCompetencias strong{
            color:#263238 !important;
        }

        #modalPesquisaCompetencias [style*="#c1c9cf"],
        #modalPesquisaCompetencias [style*="#aeb7bf"],
        #modalPesquisaCompetencias [style*="#8f99a3"],
        #modalPesquisaCompetencias [style*="#7f94a4"],
        #modalPesquisaCompetencias [style*="#e1e5e8"]{
            color:#68757f !important;
        }

        #modalPesquisaCompetencias [style*="font-size:16px"][style*="font-weight:600"]{
            color:#263238 !important;
        }

        #modalPesquisaCompetencias [style*="#075f9c"],
        #modalPesquisaCompetencias [style*="#07558f"]{
            background:#0b6fa8 !important;
            background-color:#0b6fa8 !important;
            color:#ffffff !important;
        }

        #modalPesquisaCompetencias [style*="#1591d2"]{
            color:#0b6fa8 !important;
        }


        /* =====================================================
           MODAL ESCOLHER CARGO
           ===================================================== */

        #modalEscolhaCargoCompetencia > div{
            background:rgba(31,41,51,.45) !important;
        }

        #modalEscolhaCargoCompetencia > div > div{
            background:#ffffff !important;
            background-color:#ffffff !important;
            color:#263238 !important;
            border-color:#dfe4e8 !important;
        ...
        #modalEscolhaCargoCompetencia h2{
            color:#0b6fa8 !important;
        }

        #modalEscolhaCargoCompetencia label{
            color:#263238 !important;
        }

        #modalEscolhaCargoCompetencia select{
            background:#ffffff !important;
            background-color:#ffffff !important;
            color:#263238 !important;
            border:1px solid #cbd5df !important;
        ...
        #modalEscolhaCargoCompetencia option{
            background:#ffffff !important;
            color:#263238 !important;
        }

        #modalEscolhaCargoCompetencia [style*="#1e252c"]{
        ...
        #modalEscolhaCargoCompetencia [style*="#8f99a3"]{
            color:#68757f !important;
        }

        #modalEscolhaCargoCompetencia [style*="#303840"]{
            border-color:#e3e8ec !important;
        }

        #modalEscolhaCargoCompetencia button[id="btnFecharCargoCompetencia"]{
            background:#ffffff !important;
            background-color:#ffffff !important;
            color:#52616d !important;
            border-color:#cbd5df !important;
        ...
        /* =====================================================
           AJUSTE DA MATRIZ - LARGURA DAS COLUNAS
           ===================================================== */

        .sistema-layout .tabela-container{
            width:100% !important;
            overflow-x:auto !important;
            overflow-y:visible !important;
        }

        .sistema-layout .tabela-container table{
        ...
        /* COLUNA COMPETÊNCIA */
        .sistema-layout .tabela-container table th:first-child,
        .sistema-layout .tabela-container table td:first-child{
        ...
        /* COLUNAS DOS CARGOS */
        .sistema-layout .tabela-container table th:not(:first-child):not(:last-child),
        .sistema-layout .tabela-container table td:not(:first-child):not(:last-child){
        ...
        /* ÚLTIMA COLUNA - AÇÃO */
        .sistema-layout .tabela-container table th:last-child,
.sistema-layout .tabela-container table td:last-child{
    ...
    box-sizing:border-box !important;
        ...
        /* SELECT 0-4 DENTRO DA COLUNA */
        .sistema-layout .tabela-container table td:not(:first-child):not(:last-child) select.nivel{
            width:52px !important;
            min-width:52px !important;
            max-width:52px !important;
            margin:0 auto !important;
