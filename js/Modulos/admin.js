const ModuloAdmin = {
    ...
    abrir(usuario, banco) {
                        ...
                        <strong>
                            ${
                                Array.isArray(banco.habilidades)
                                    ? banco.habilidades.length
                                    : 0
                            }
                        </strong>

                        <p>
                            Competências disponíveis no catálogo global
                        </p>
        ...
        // =====================================================
        // CATÁLOGO DE COMPETÊNCIAS / IMPORTAR EXCEL
        // =====================================================

        const btnAdminCatalogo =
            document.getElementById(
                "btnAdminCatalogo"
            );
        ...
        if (btnAdminCatalogo) {
            ...
            btnAdminCatalogo.onclick = () => {

                if (
                    typeof ModuloAdminCatalogo !==
                    "undefined"
                ) {

                    ModuloAdminCatalogo.abrir(
                        usuario,
                        banco
                    );
                    ...
                    console.error(
                        "ModuloAdminCatalogo não foi carregado."
                    );


                    alert(
                        "O módulo de Catálogo de Competências não foi carregado.\n\n" +
                        "Verifique se o arquivo adminCatalogo.js foi incluído no index.html."
                    );
